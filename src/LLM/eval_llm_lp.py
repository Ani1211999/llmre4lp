...
def main():
    ...
    pred_file = "inference_results_lp_llm/amazon_clothing_test/preds.json"  # Path to your prediction file
    true_file = "../../amazon_clothing_test_all_reduced.json"  # Path to ground truth
    metrics_file = "inference_results_lp_llm/amazon_clothing/llm_metrics.txt"  # Output metrics file
