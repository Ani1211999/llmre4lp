...
for epoch in range(args.epochs):
    ...
    yes_param = torch.sigmoid(net.layers[0].yes_weight)
    no_param = torch.sigmoid(net.layers[0].no_weight)
...
model_filename = f"llm4heg_model_depth{args.layer_num}_lr{args.lr}_wd{args.weight_decay}_seed{args.seed}.pth"
