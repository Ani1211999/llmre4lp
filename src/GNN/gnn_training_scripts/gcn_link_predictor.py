...
# Main
# -------------------------
def main(npz_path, hidden_dim=64, epochs=200, lr=1e-2, device='cuda:0',dataset_name='Arxiv'):
    ...
    save_preds_as_json(test_edges, test_pos_score, test_neg_edges, test_neg_score, f"results/GNN/{dataset_name}_v2/test_preds.json")
    os.makedirs(f"results/GNN/baselines/{dataset_name}/", exist_ok=True)
    with open(f"results/GNN/baselines/{dataset_name}/eval_metrics.txt","w") as writer:
