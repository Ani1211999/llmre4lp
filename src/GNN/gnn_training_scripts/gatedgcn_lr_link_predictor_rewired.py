...
def main(npz_path, hidden_dim=64, epochs=200, lr=1e-2, device='cuda:0',dataset_name='Cora', rewired_path=None):
    ...
    os.makedirs(f"results/GNN/baselines/{dataset_name}_hop3_GatedGCN_rewired/", exist_ok=True)
    with open(f"results/GNN/baselines/{dataset_name}_hop3_GatedGCN_rewired/eval_metrics.txt", "w") as writer:
